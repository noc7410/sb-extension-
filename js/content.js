...
module.exports = __webpack_require__("8bbd");
...
var data = {}; //handle extension events

chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
  if (request.command == "parse-site") {
    //page not supported
    chrome.runtime.sendMessage({
      "command": "parse-product-failed"
    });
  }
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {//check if site is supported
});
